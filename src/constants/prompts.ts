...
3. Objects in Scene (additional items)
   - Additional objects (relevant to the username)
     - Types
     - Positions
     - Attributes
...
export const DALLE_IMAGE_PROMPT_TEMPLATE_NO_BANNER = `Your task is to create concise and focused image generation prompt using the provided structured data.
